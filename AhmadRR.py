...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('xdg-open https://www.facebook.com/profile.php?id=100004820957579', {
...
def i():
    ...
    jalan('\033[1;32m============================================')
    jalan('\033[1;36m     \t     INDIA CODES\n     \033[1;33m88016, \033[1;33m91930 ,\033[1;33m91902 ,\033[1;33m1712  ...\033[0;97m')
    jalan('\033[1;32m============================================\n')
    code = input(' PUT CODE : ')
    print("")
